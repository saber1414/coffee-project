...
const Reservation = () => {
  ...
  const submitFormHandler = async (e) => {
    e.preventDefault();
    let reservationInfos = { name, email, date, time, person };

    const res = await fetch("http://localhost:4000/reservation", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(reservationInfos),
    });
    ...
    if (res.ok) {
      Swal.fire({
        icon: "success",
        title: "success",
        text: "Cafe reservation successfully completed",
      });
      setName("");
      setDate("");
      setEmail("");
            ...
            <div className="row align-items-center">
              <div className="col-lg-6 my-5 my-lg-0">
                <div className="p-5">
                  ...
                  <ul className="list-inline text-white m-0">
                    <li className="py-2">
                      <FontAwesomeIcon
                        classNameName="text-primary mr-3"
                        icon={faCheck}
                      />
              ...
              <div className="col-lg-6">
                ...
                >
                  ...
                  <form onSubmit={submitFormHandler} className="mb-5">
